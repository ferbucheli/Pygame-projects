## Vamos a organizar el codigo de una mejor manera usando sprite classes
## Permite crear objetos (jugador, bola)

# Sprite - es una clase que une una superficie con un rectangulo (merges a surface with a rectangle)
...
# Donde la logica del juego se ejecuta
class GameManager:
...
plob_sound = pygame.mixer.Sound("images/pong.ogg")
score_sound = pygame.mixer.Sound("images/score.ogg")
middle_strip = pygame.Rect(screen_width/2 - 2,0,3,screen_height)
